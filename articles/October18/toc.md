...
### Retail の地域別機能
#### [インドにおけるアップグレードおよび N-1 のサポート](dynamics365-retail/retail-upgrade-n-1-india.md)
...
### [Dynamics 365 レイアウト](mixed-reality/microsoft-layout/index.md)
...
#### [カスケード ドロップダウンの構成がより簡単に](powerapps/easier-to-configure-cascading-dropdowns-and-conditional-field-visibility.md)
...
#### [Microsoft Teams が Flow をボットとして使用](microsoft-flow/microsoft-teams-uses-flow-as-a-bot.md)
