...
## [営業](dynamics365-sales/sales-performance-at-scale-productivity-collaboration.md)
...
#### [フローによる SharePoint コンテンツ承認のカスタマイズ](microsoft-flow/customize-sharepoint-content-approvals-with-flow.md)
...
#### [失敗したフローに対する電子メール内のヒントの修復](microsoft-flow/repair-recommendations-sent-in-email-for-failed-flows.md)
...
#### [新しい Flow ポータルとデザイナー エクスペリエンス](microsoft-flow/flow-designer-enhancements.md)
...
##### [アド ホック探索](intelligence-platform/power-bi-desktop/adhoc-exploration.md)
...
##### [自動機械学習データフロー](intelligence-platform/power-bi-service/automated-ml-dataflows.md)
##### [Azure Machine Learning の統合](intelligence-platform/power-bi-service/azure-ml-integration.md)
...
##### [レポートのコメント](intelligence-platform/power-bi-service/commenting.md)
