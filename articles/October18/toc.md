...
### [Microsoft Stream を使用したビデオ コンテンツ](dynamics365-marketing/marketing/video-content.md)
...
#### [共有の機能強化](powerapps/sharing-enhancements-for-canvas-apps.md)
...
#### [アクセスしやすくなった Dynamics 365 の Reporting Services レポート](powerapps/reporting-services-reports-available-on-unified-interface.md)
...
#### [アプリ用 Common Data Service のロールアップ ビューの拡張](powerapps/enhancements-to-roll-up-views-in-unified-interface.md)
#### [アプリ用 Common Data Service の Outlook Client v8.2 の信頼性向上](powerapps/more-reliable-outlook-client-v8.2-for-dynamics-365.md)
#### [アプリ用 Common Data Service の Outlook Client v9.0 の信頼性向上](powerapps/more-reliable-outlook-client-v9.0-for-dynamics-365.md)
#### [アプリ用 Common Data Service の関連設定検索の強化](powerapps/set-regarding-lookup-enhancements-in-common-data-service.md)
#### [アプリ用 Common Data Service での代理ユーザーのサポート](powerapps/support-for-delegate-users-in-dynamics-365.md)
