---
title: 文書フォーカス モード
description: ドキュメントを拡大し、完全なリストのすべての強力な機能にアクセスします。
author: blazkote
ms.reviewer: edupont
ms.date: 01/21/2019
ms.topic: article
...
ms.author: blazkote
audience: end user
ms.openlocfilehash: a5b568aaf8de8ef541c456a1fea00b51ea975e87
...
ms.locfileid: "210297"
---
# <a name="document-focus-mode"></a><span data-ttu-id="01002-103">文書フォーカス モード</span><span class="sxs-lookup"><span data-stu-id="01002-103">Document focus mode</span></span>
[!include[dynamics365-business-central banner](../includes/dynamics365-business-central.md)]

<span data-ttu-id="01002-104">長く要求の厳しいドキュメントを編集することが多いお客様のために、ドキュメントの明細項目セクションを拡大して画面の大部分を占めるようにし、生産的で素早いデータ入力のためのスペースを空ける、特別なビューを作成しました。</span><span class="sxs-lookup"><span data-stu-id="01002-104">For those of our customers who often edit long and demanding documents, we have created a special view expanding the line item section of the document to take a larger part of the screen and leave more room for productive and fast data entry.</span></span> <span data-ttu-id="01002-105">このモードでドキュメントを表示すると、高度なフィルタリングも使用できるので、長いドキュメントの閲覧や検索が簡単になります。</span><span class="sxs-lookup"><span data-stu-id="01002-105">When viewing documents in that mode, it is also possible to use advanced filtering, so browsing and searching through longer documents becomes easier.</span></span>
